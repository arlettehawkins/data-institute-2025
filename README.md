...
We'll use this page to add all the materials used to teach the [2024 Data Institute](https://cjddatainstitute.org/2025/): slides, exercises, links, and homework. This is not an online course and won't have all the context or instruction to be a standalone class.
